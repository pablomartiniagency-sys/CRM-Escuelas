...
const ContactosPage = lazy(() =>
  import("@/pages/Contactos").then((m) => ({ default: m.ContactosPage }))
)
const AlumnosPage = lazy(() => import("@/pages/Alumnos").then((m) => ({ default: m.AlumnosPage })))
const ActividadesPage = lazy(() =>
  import("@/pages/Actividades").then((m) => ({ default: m.ActividadesPage }))
)
const LeadsPage = lazy(() => import("@/pages/Leads").then((m) => ({ default: m.LeadsPage })))
const ComunicadosPage = lazy(() =>
  import("@/pages/Comunicados").then((m) => ({ default: m.ComunicadosPage }))
)
const AusenciasPage = lazy(() =>
  import("@/pages/Ausencias").then((m) => ({ default: m.AusenciasPage }))
)
...
const ConfigPage = lazy(() =>
  import("@/pages/Configuracion").then((m) => ({ default: m.ConfiguracionPage }))
)
