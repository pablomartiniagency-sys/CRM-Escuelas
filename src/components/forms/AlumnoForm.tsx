...
const NIVELES = ["Primer Ciclo (0-3)", "Segundo Ciclo (3-6)", "Primaria 1º-2º", "Primaria 3º-4º", "Primaria 5º-6º", "ESO 1º", "ESO 2º", "ESO 3º", "ESO 4º", "Bachillerato"]
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
      <div className="grid grid-cols-2 gap-4">
        <div className="col-span-2">
          ...
          <input {...register("nombre_completo")} placeholder="Ana Lopez Martinez"
        ...
        <div>
          ...
          <input {...register("aula")} placeholder="1A, Mariposas, Leones..."
            className="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        ...
        <div>
          ...
          <input {...register("curso_escolar")} placeholder="2025-2026"
            className="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        ...
        <div className="col-span-2">
          ...
          <input {...register("alergias")} placeholder="Alergia al gluten, lactosa..."
            className="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>

        <div className="col-span-2">
          <label className="block text-sm font-medium text-gray-700 mb-1.5">Notas medicas</label>
          <textarea {...register("notas_medicas")} rows={2}
        ...
        <div className="col-span-2 flex items-center gap-2">
          ...
          <label htmlFor="activo_alumno" className="text-sm text-gray-700">Alumno activo en el centro</label>
        </div>
      </div>
